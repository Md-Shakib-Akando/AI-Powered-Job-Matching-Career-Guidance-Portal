...
export default function HowToMatch() {
    return (
        <div className='bg-gray-100'>
            <div className='xl:max-w-10/12 mx-auto py-20 px-5 lg:px-0'>
                ...
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-10'>
                        <div className='bg-white rounded-xl shadow-lg p-10 md:p-5 lg:p-10 hover:shadow-xl transition-shadow duration-300'>
